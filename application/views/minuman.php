...
<img src="<?php echo base_url('asset/css/kitchen1.jpg')?>" style="position:absolute; top:-100px; height: 1268px;">
...
<img src="<?php echo base_url('asset/css/serv.jpg')?>" style="position:absolute; top: 1080px; height: 700px; width: 1900px;">
...
<ul class="nav">
	  ...
	  <a href="#">
	   <img src="<?php echo base_url('asset/css/instagram.png')?>" class="ig" style="position:absolute; top: 22px; left: 1485px; height: 25px">
	   </a>
	   
	     <a href="#">
	   <img src="<?php echo base_url('asset/css/facebook.png')?>" class="ig" style="position:absolute; top: 22px; left: 1510px; height: 25px">
	   </a>
	   
	     <a href="#">
	   <img src="<?php echo base_url('asset/css/twitter.png')?>" class="ig" style="position:absolute; top: 22px; left: 1535px; height: 25px">
	   </a>
